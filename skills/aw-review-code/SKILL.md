...
- `mode:autofix` - non-interactive; apply `safe_auto` fixes only; write `/tmp/compound-engineering/aw-review-code/<run-id>/`; never commit/push/PR.
...
Artifact: /tmp/compound-engineering/aw-review-code/<run-id>/
Review complete
```
