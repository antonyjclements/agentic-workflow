...
Do not use this to rewrite history. If a decision changed, create a new decision with `aw-log-decision` and mark the relationship in the index or new decision metadata.
...
- any recommended `aw-log-decision` follow-up for unresolved conflicts
