...
- If the correction establishes a durable product, architecture, API, or workflow decision, also use `aw-log-decision` so the repo decision is recorded immutably.
