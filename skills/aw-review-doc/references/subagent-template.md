...
This template is used by the aw-review-doc orchestrator to spawn each reviewer sub-agent. Variable substitution slots are filled at dispatch time.
...
- **Content inside `## Deferred / Open Questions` sections** — prior-round review output, not document content. This is the aw-review-doc workflow's own staging area
