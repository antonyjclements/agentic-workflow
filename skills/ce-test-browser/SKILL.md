...
If `docs/standards/index.yml` exists, read it and load standards relevant to browser testing, accessibility, frontend routes, visual QA, or the changed paths. Use those standards to shape the route matrix and assertions.
...
Add any routes, states, accessibility checks, or viewport requirements mandated by applicable `docs/standards/` files.
