...
Run the configured `synthesize_memory` auxiliary for the first time. If patterns are emerging across sessions, promote them to learnings. Skip wiki generation until there is enough signal to make it useful.
