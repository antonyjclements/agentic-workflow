...
13. Run the capture checkpoint: `aw-log-decision`, `aw-record-retrospective`, `aw-capture-solution`, or `aw-log-session` when appropriate. Offer `aw-log-session` at natural session ends to feed the synthesis loop.
